...
# n_population = 250
n_population = 120  # if cities are reduced than population which is formed from
                    # permutations, can't exceed number of permutations
crossover_per = 0.8
mutation_per = 0.2
n_generations = 200
...
def roulette_wheel(population, fitness_probs):
    ...
    bool_prob_array = population_fitness_probs_cumsum < np.random.uniform(
        0, 1, 1)
...
if __name__ == '__main__':
    best_mixed_offsrping = run_ga(
        cities_names, n_population, n_generations, crossover_per, mutation_per)
    print(best_mixed_offsrping[:2])
