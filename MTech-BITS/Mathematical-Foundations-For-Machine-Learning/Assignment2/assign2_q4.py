...
def C(x):
    ...
    x1, x2 = x[0], x[1]  # Assuming x is a 2D numpy array with x1 and x2 elements
    # import pdb;pdb.set_trace()
    return (3 * x2**2 + 2 * x1**2 + 20 * np.cos(x1) * np.cos(x2)).reshape(1,-1)
